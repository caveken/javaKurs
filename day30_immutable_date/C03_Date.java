...
public class C03_Date {
    public static void main(String[] args) {
        ...
        LocalDate tarih2 = LocalDate.of(2000, 7, 9);
        System.out.println(tarih2);

        LocalDate tarih3 = LocalDate.of(2012, Month.JUNE, 20);
        ...
        System.out.println(tarih2.plusYears(11).plusMonths(11).plusDays(11)); // 2027-11-04
