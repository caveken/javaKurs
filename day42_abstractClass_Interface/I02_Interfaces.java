package javaKurs.day42_abstractClass_Interface;
...
public interface I02_Interfaces {
    ...
    static void girilenSayiyaKadarOlanArmstrongSayilar(int sayi) {
    ...
    private static void armstrong(int sayi) {
        ...
        }else System.out.println("girilenSayi armstrong sayi degildir = " + girilenSayi);
    }
}
